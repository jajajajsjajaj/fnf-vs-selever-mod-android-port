...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...initSonglist.length)
		{
			...
			try {
				...
				diffs.push(null);
				diffsThatExist.remove("Hard");
			}
			if (diffsThatExist.length == 0) {
				trace("No difficulties found for song \"" + meta.songName + "\", skipping.");
				continue;
			}
	...
	{
		//Screw this, this game's code is unsalvageable!
